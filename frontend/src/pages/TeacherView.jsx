      ...
      <div className="mt-6 flex gap-4 overflow-x-auto">
        <Card className="min-w-[300px] relative">
          ...
          <CardContent className="absolute bottom-0 left-0 right-0 p-2 bg-white bg-opacity-80">
            <div className="text-sm font-medium text-red-600">Average Attention</div>
        ...
        <Card className="min-w-[300px] relative">
          ...
          <CardContent className="absolute bottom-0 left-0 right-0 p-2 bg-white bg-opacity-80">
            <div className="text-sm font-medium text-green-600">Average Attention</div>
            <div className="font-bold text-green-600">72.8%</div>
          </CardContent>
        </Card>

        <Card className="min-w-[300px] relative border-2 border-blue-600">
          <img src="/attention3.png" className="w-full h-40 object-cover opacity-80" />
          <CardContent className="absolute bottom-0 left-0 right-0 p-2 bg-white bg-opacity-80">
            <div className="text-sm font-medium text-gray-600">Average Attention</div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="mt-6 bg-gray-50 p-4 rounded-lg">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="bg-white border rounded-lg w-full flex mb-4">
            <TabsTrigger value="students" className="w-full py-2">Students</TabsTrigger>
            <TabsTrigger value="quizzes" className="w-full py-2">Quizzes</TabsTrigger>
          </TabsList>

          {activeTab === 'students' && (
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                <img src="https://randomuser.me/api/portraits/women/10.jpg" className="w-8 h-8 rounded-full" />
                <p className="font-medium">Laila Oreoluwa</p>
                <span className="ml-auto text-blue-600 font-semibold">9 points</span>
              </div>
              <div className="flex items-center gap-4">
                <img src="https://randomuser.me/api/portraits/women/11.jpg" className="w-8 h-8 rounded-full" />
                <p className="font-medium">Laila Oreoluwa</p>
                <span className="ml-auto text-blue-600 font-semibold">9 points</span>
              </div>
            </div>
